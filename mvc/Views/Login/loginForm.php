<?php
    ...
    // {
    //     echo '<script>window.location.href="../ChatRealtime/getChatBox";</script>';
    // }
    // else
    // {
...
<div class="container">
    <section id="content">
        <form action="Login/postFormLogin" method="post">
            ...
            <input type="hidden" name="contentqrcode">
            <div>
            ...
            <input type="button" name="loginqr" id="loginqr" class="btn btn-primary mb-3" value="Sử dụng mã QR của tôi để đăng nhập.">
    ...
    scanner.addListener('scan', function(content){
        $.ajax({
            ...
            success: function(data){
                ...
                //     case 2:
                //     window.location.href="Login/getFormLogin";
                //     alert("QRCode đã hết hạn.");
                //     break;
                //     case 0:
                //     window.location.href="Login/getFormLogin";
                //     alert("QRCode không đúng.");
                //     break;
                // }
            },
