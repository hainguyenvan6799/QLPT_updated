      ...
      <div class="card card-solid">
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-6">
              <h3 class="my-3">Thông tin phòng</h3>
              <hr>
              <h4></h4>
              ...
              <div class="py-2 px-3 mt-4">
                ...
                <a id="addClass" data-userId="1"><span class="glyphicon glyphicon-comment addClass"></span> Chat với chủ phòng trọ </a>
              </div>
            </div>
          </div>
          <div class="row mt-4">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#user_login_status').css("display", "none");
  });
</script>